...
export function ProductCatalog() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative overflow-hidden bg-gradient-to-b from-white via-neutral-50/50 to-white py-16 md:py-24"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div
          className={`mb-16 space-y-4 text-center transition-all duration-700 ${
        ...
        {/* Products Grid */}
        <div
          className={`grid gap-6 md:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 transition-all duration-700 ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
        ...
        {/* CTA Section */}
        <div
          className={`mt-16 rounded-2xl border border-neutral-200/50 bg-gradient-to-r from-white/50 to-white/30 backdrop-blur-sm p-8 md:p-12 text-center transition-all duration-700 ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{
